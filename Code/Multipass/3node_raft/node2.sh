...
endpoint = "tcp://192.168.64.6:8800"

peers = ["tcp://192.168.64.4:8800","tcp://192.168.64.5:8800"]
...
opentsdb_url = "http://192.168.64.7:8086"
opentsdb_db = "metrics"
...
sed -i '/\[outputs.influxdb\]/a \ \ urls = \[\"http://192.168.64.7:8086\"\]\n  database = \"metrics\"\n  username = \"lrdata\"\n  password = \"test\"' /etc/telegraf/telegraf.conf
